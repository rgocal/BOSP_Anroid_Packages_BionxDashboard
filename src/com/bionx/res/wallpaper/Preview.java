...
package com.bionx.res.wallpaper;
...
import com.bionx.res.wallpaper.koushikdutta.urlimageviewhelper.UrlImageViewCallback;
import com.bionx.res.wallpaper.koushikdutta.urlimageviewhelper.UrlImageViewHelper;
...
public class Preview extends Activity {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            ImageView v = (ImageView) findViewById(R.id.holder);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_DOWNLOAD_PROGRESS:
                ...
                mProgressDialog.setMessage("Processing...Applying...");
