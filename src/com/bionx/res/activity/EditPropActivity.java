...
public class EditPropActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tempFile = Environment.getExternalStorageDirectory().getAbsolutePath()
				+ "/buildprop.tmp";
		propReplaceFile = Environment.getExternalStorageDirectory()
				.getAbsolutePath() + "/propreplace.txt";
		setUpControls();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.save_menu:
			...
			prop.setProperty(editName.getText().toString(), editKey.getText()
					.toString());
					...
					.setPositiveButton(R.string.save,
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									prop.setProperty(editName.getText()
											.toString(), editKey.getText()
											.toString());
	...
	private void transferFileToSystem() {
		...
		try {
			...
			os.writeBytes("busybox cp -f " + propReplaceFile
					+ " /system/build.prop\n");
