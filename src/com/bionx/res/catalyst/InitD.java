...
import com.bionx.res.helpers.InitCMD;
import com.bionx.res.helpers.InitHelper;
...
public class InitD extends PreferenceFragment implements
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
            ...
            if (key.equals(KEY_ENABLE_INITD)) {
                ...
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_ZIPALIGN + "=.*|"
                ...
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_ENABLE_SDBOOST + "=.*|"
                ...
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_SDBOOST + "=.*|"
                ...
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_FIX_PERMS + "=.*|"
                ...
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_CLEAR_CACHE + "=.*|"
                ...
                final String value = clear_cache ? "1" : "0";
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_CACHE + "=.*|"
                        + VAR_CACHE + "=" + value + "|' " + cfg);
                InitHelper.getMount("ro");
                ...
                final String value = clear_cache ? "1" : "0";
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_RAM_BOOT + "=.*|"
                ...
                final String value = clear_cache ? "1" : "0";
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_RGDN + "=.*|"
                        + VAR_RGDN + "=" + value + "|' " + cfg);
                InitHelper.getMount("ro");
                ...
                final String value = clear_cache ? "1" : "0";
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_SQLITE + "=.*|"
                ...
                final String value = clear_cache ? "1" : "0";
                InitHelper.getMount("rw");
                new InitCMD().su.runWaitFor("busybox sed -i 's|" + VAR_TETHER + "=.*|"
        ...
        private String getVariableValue(final String variable) {
            ...
            if (value == null) {
                final String s = new InitCMD().su.runWaitFor("busybox grep " + variable + " "
                        + cfg).stdout;
                if (s != null) {
