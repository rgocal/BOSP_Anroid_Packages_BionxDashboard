...
public class GPUCommandResult implements Parcelable {
    ...
    public GPUCommandResult(long startTime,
                         int exitValue,
                         String stdout,
                         String stderr,
                         long endTime) {
    ...
    // loading constructor
    public GPUCommandResult(Parcel inParcel) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GPUCommandResult)) return false;

        GPUCommandResult that = (GPUCommandResult) o;
